...
| **statsmodels** | Time series decomposition, ARIMA forecasting, OLS regression with diagnostics, retention curve modeling (half-life, decay projection) | Import directly |
...
| [advanced-analysis.md](references/advanced-analysis.md) | Statistical methods, trend analysis, graph algorithms, visualization gallery, scikit-learn (clustering, anomaly detection, prediction), statsmodels (forecasting, regression, retention curve modeling) |
