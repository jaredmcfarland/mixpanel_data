...
class TestTransformFunnelResult:
    ...
    def test_missing_series_yields_empty_steps_data(self) -> None:
        """Missing series key yields empty steps_data list."""
        raw: dict[str, Any] = {
            "computed_at": "2025-01-15T12:00:00",
            "date_range": {"from_date": "2025-01-01", "to_date": "2025-01-31"},
            "meta": {},
    ...
    def test_minimal_raw_response(self) -> None:
        """Minimal response with no optional fields produces valid result with defaults."""
        raw: dict[str, Any] = {}
