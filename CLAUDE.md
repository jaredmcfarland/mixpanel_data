...
- Python 3.10+ (matches existing project requirements) + FastMCP 2.x, mixpanel_data library, Pydantic v2 (022-analytics-loop)
- DuckDB (via mixpanel_data Workspace for local queries) (022-analytics-loop)
